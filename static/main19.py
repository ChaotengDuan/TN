...
import torch.optim
from models.ResNet19 import *
import data_loaders
from functions import TET_loss, seed_all, get_logger
from torch.utils.tensorboard import SummaryWriter

# os.environ["CUDA_VISIBLE_DEVICES"] = "0,1,2,3,8,9,10,11"
...
if __name__ == '__main__':
    ...
    model = ResNet(method=args.method)
    print(model)
    ...
    out_dir = os.path.join(args.out_dir,
                           f'CIFAR100_R19_method_{args.method}_T_{args.time}_b_{args.batch_size}_')
    ...
    logger = get_logger(f'R19C100_method_{args.method}_.log')
